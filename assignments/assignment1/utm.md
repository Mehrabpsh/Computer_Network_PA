...
ssh into the VM and run `git clone https://github.com/Mehrabpsh/Computer_Network_PA` 
to download the course files from GitHub.

Then `cd Computer_Network_PA/assignments` to enter the course assignment directory.
